...
contract AbsoluteVote is IntVoteInterface {
   ...
   */
     ...
     * @param _organization an address to be sent as the payload to the _executable contract.
     * @param _executable This contract will be executed when vote is over.
     * @return proposal's id.
     */
    function propose(uint _numOfChoices, bytes32 _paramsHash, address _organization, ExecutableInterface _executable,address)
        external
        returns(bytes32)
    {
        ...
        emit NewProposal(proposalId, _organization, _numOfChoices, msg.sender, _paramsHash);
        return proposalId;
    }
        ...
        for (uint i = 0; i < _voters.length; i++) {
            ...
            if (voter.reputation > 0) {
                ...
                if (rep != voter.reputation) {
                    ...
                    emit RefreshReputation(_proposalId, proposal.organization, _voters[i],rep);
                }
             }
        }
        return true;
